...
def main():
    ...
    # trained_model, test_data_classes = train_logistic_regression(train_data_features, train_data_classes,
    #                                                              test_data_features)
    # evaluate_model(model_name, test_data_classes, actual_classes)
    # # cross_validate(model_name, trained_model, train_data_features, train_data_classes)
    #
...
def read_data(ngram_val):
    ...
    vectorizer = TfidfVectorizer(analyzer="word", stop_words=stopwords.words('english'), ngram_range =(ngram_val,ngram_val), tokenizer=None, preprocessor=None, min_df=1)
...
def cross_validate(model_name, trained_model, train_data_features, train_data_classes):
    ...
    train_sizes, train_scores, valid_scores = learning_curve(trained_model, train_data_features, train_data_classes, train_sizes=[50, 80, 1735], cv=5, scoring="f1_macro")
